...
var ClobClient = require('@polymarket/clob-client').ClobClient;
...
var client = new ClobClient('https://clob.polymarket.com', 137, wallet);
function getOpenAndActiveMarkets() {
    return __awaiter(this, void 0, void 0, function () {
        var marketsData, markets, openAndActiveMarkets, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, client.getMarkets()];
                case 1:
                    marketsData = _a.sent();
                    console.log("Fetched markets data structure:", marketsData);
                    markets = marketsData.data || [];
                    openAndActiveMarkets = markets.filter(function (market) { return market.active === true && market.closed === false; });
